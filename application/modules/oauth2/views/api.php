      ...
      <form class="form-inline">
        ...
        <div class="form-group">
          <label for="Credentials">
            <h3>Resource Owner Password Credentials:</h3><br>
        ...
        <div class="form-group">
          <label for="ClientCredentials">
            <h3>Client Credentials: </h3><br>
        ...
        <div class="form-group">
          <label for="authorize">
            ...
            <div>Link Auth <a target="_blank" href="<?= base_url(); ?>oauth2/authorize?response_type=code&client_id=client&redirect_uri=http://www.aditya-nursyahbani.net&state=xyz&scope=country"><?= base_url(); ?>oauth2/authorize?response_type=code&client_id=client&redirect_uri=<?= base_url('oauth2/test'); ?>&state=xxx&scope=country</a></div><br>
          </label><br>
  ...
  <script>
    $(document).ready(function() {
      $("#btn-refresh").click(function(e) {
        ...
        $.post('<?= base_url(); ?>oauth2/RefreshToken', data, function(d) {
      ...
      $('#btn-authorize').click(function(e) {
        var data = {
          code: $("#authorize-code").val(),
          client_id: 'client',
          client_secret: 'mysecret',
          redirect_uri: "http://www.aditya-nursyahbani.net",
          grant_type: 'authorization_code',
          scope: 'country'
        };
        $.post('<?= base_url(); ?>oauth2/authorize/token', data, function(d) {
      ...
      $('#btn-resource').click(function(e) {
        var data = {
          access_token: $("#resource").val()
        };
        
        $.post('<?= base_url(); ?>api/countries', data, function(d) {
      ...
      $('#btn-resource-limit').click(function(e) {
        ...
        $.post('<?= base_url(); ?>oauth2/resource/limit', data, function(d) {
          console.log("Get Authorize => ", d);
          $('#return-resource').html(JSON.stringify(d));
        }, "json");
      });
      ...
      $('#btn-PasswordCredentials').click(function(e) {
        ...
        $.post('<?= base_url(); ?>oauth2/PasswordCredentials', data, function(d) {
      ...
      $("#btn-ClientCredentials").click(function(e) {
        ...
        $.post('<?= base_url(); ?>oauth2/ClientCredentials', data, function(d) {
          //d = d.JSON.parse(d);
